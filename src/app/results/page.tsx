  ...
  return (
    <div className="pt-16 min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-20 pb-16">
        ...
        <h1 className="text-3xl font-semibold text-foreground mb-4">ผลการแข่งขัน</h1>
        <p className="text-sm text-muted-foreground leading-relaxed max-w-xl">
          สรุปผลการแข่งขันที่เสร็จสิ้นแล้วของแต่ละสาย แบบเรียลไทม์
        </p>
      </div>
            ...
            <div className="space-y-8">
              ...
              {matches.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-dashed border-border/40 rounded-2xl bg-card/20">
                  ...
                  <p className="text-base font-bold text-foreground">ยังไม่มีผลการแข่งขัน</p>
                  <p className="text-sm text-muted-foreground mt-2">
                    ผลการแข่งขันที่จบแล้วจะแสดงที่นี่
                  </p>
                </div>
              ) : (
